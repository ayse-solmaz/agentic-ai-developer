...
**Current:** Day 16 (Tree of Thoughts / planning) — next up
...
| 16 | Advanced planning (ToT) | Next | Task decomposition beyond simple ReAct | — |
...
| Specialized Agent Development | 16–20 | Planning, code/SQL agents, deploy | **Next** |

## Skills gained (Days 1–15)
