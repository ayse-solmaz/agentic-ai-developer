...
**Current:** Day 6 next (structs) — phase 1–5 closed
...
| 5 | Fundamentals practice | Done | CLI calc, CtoF/FtoC in `calc`, `go fmt` / edge cases | [day-5.md](./day-5.md), [main.go](./main.go) |
...
| Structs, Methods & Interfaces | 6–10 | Structs, methods, interfaces | Next |
| Errors, Collections & I/O | 11–15 | | |
...
Always from the module root (not the git repo root):
