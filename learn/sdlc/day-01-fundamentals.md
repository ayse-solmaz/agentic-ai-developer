...
## My definition
**SDLC (Software Development Life Cycle)** is a systematic and repeatable process model in which a piece of software progresses from the idea/requirement stage through planning, design, development (coding), testing, deployment, and maintenance stages.

## Core phases
1. **Requirements** — users and stakeholders come together to define what needs to be built.
...
## App mapping
**App:** WhatsApp
**Recent change I noticed:** The "nickname" feature was added
**Likely phase:** Deployment
**Why:** It was added as a new feature and was released to users for the first time.
